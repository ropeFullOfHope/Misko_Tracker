...
const region_t REGION_PROJECT_TITLE                   = {.start = {1, 1}, .size = {32,  1}};
const region_t REGION_PROJECT_EDITOR_PROJECT_SETTINGS = {.start = {1, 3}, .size = {32,  2}};
const region_t REGION_PROJECT_EDITOR_PREFERENCES      = {.start = {1, 6}, .size = {32, 23}};

const region_t REGION_SONG_TITLE       = {.start = {1, 1}, .size = {32,  1}};
const region_t REGION_SONG_EDITOR_SONG = {.start = {1, 3}, .size = {29, 26}};

const region_t REGION_CHAIN_TITLE                 = {.start = { 1, 1}, .size = {32,  1}};
...
const region_t REGION_PHRASE_TITLE                      = {.start = {1,  1}, .size = {32,  1}};
...
const region_t REGION_INSTRUMENT_TITLE                = {.start = {1, 1}, .size = {32,  1}};
