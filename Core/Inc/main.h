...
#define SD_CARD_SCK_Pin LL_GPIO_PIN_5
#define SD_CARD_SCK_GPIO_Port GPIOA
#define SD_CARD_MISO_Pin LL_GPIO_PIN_6
#define SD_CARD_MISO_GPIO_Port GPIOA
#define SD_CARD_MOSI_Pin LL_GPIO_PIN_7
...
#define BUTTON_RIGHT_Pin LL_GPIO_PIN_8
...
#define LCD_NRST_Pin LL_GPIO_PIN_3
...
#define LCD_BACKLIGHT_Pin LL_GPIO_PIN_6
